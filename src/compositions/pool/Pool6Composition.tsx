...
const Pool6Composition: React.FC<Props> = ({
  setPoolInfo,
  setStakeTokenInfo,
  setPoolContract,
  ...
  useEffect(() => {
    setPoolInfo(Config.Pool6);
    setStakeTokenInfo(Config.YtslaToken);
    setPoolContract(web3client.pool6Contract);
    setStakeTokneContract(web3client.ytslaTokenContract);
