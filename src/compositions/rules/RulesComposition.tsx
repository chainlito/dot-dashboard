          ...
          <div className='rules-item'>
            <div className='rules-item__left'>
              ...
              <div className='text-small text-gray'>
                ...
                What makes the game interesting is that any player can MODIFY the Rebase Lag. 
                The Rebase Lag can be modified by pressing +/- & interacting with the contract through Metamask. 
