...
const GameBoost: React.FC<Props> = ({ allowed, boostRate, onApprove, boostUp, boostDown }: Props) => {
  ...
  return (
    <div className='game-boost'>
      ...
      <div className='mt-30 game-boost__rate'>Current rate is {(boostRate * 0.1).toFixed(1)}ETH</div>
